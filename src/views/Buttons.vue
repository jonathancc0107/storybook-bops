        ...
        <v-row class="my-4" justify="center">
          ...
          <v-col cols="12">
            <v-row align="center" justify="center">
              ...
              <BopsButton :outlined="true" text="Importado" color="indigo"/>
              <BopsButtonIcon :fab="true" :outlined="true" icon_text="mdi-pencil" color="indigo"/>
        ...
        <v-row class="my-4" justify="center">
          ...
          <v-col class="text-center" cols="12">
            <v-sheet class="px-7 pt-7 pb-4 mx-auto text-center d-inline-block" color="blue-grey darken-3" dark>
              ...
              <v-btn :loading="loading" class="ma-1" color="error" plain @click="remove">
                Delete
              </v-btn>
            </v-sheet>
          </v-col>
...
<script>
  import BopsButton from '@/components/Buttons/BopsButton.vue'
  import BopsButtonIcon from '@/components/Buttons/BopsButtonIcon.vue'
  export default {
    name: "Buttons",
    components: {
      BopsButton,
