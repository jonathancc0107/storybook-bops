  ...
  <v-container>
    <v-row justify="center">
      <v-col cols="6">
        ...
        <v-row class="my-4" justify="center">
          <v-col cols="12">
            <h3>Fade image on scroll</h3>
          </v-col>
          <v-col cols="12">
            <v-card class="overflow-hidden">
              <v-app-bar absolute color="#6A76AB" dark shrink-on-scroll prominent
                src="https://picsum.photos/1920/1080?random" fade-img-on-scroll scroll-target="#scrolling-techniques-3">
        ...
        <v-row class="my-4" justify="center">
          ...
          <v-col cols="12">
            <v-card class="overflow-hidden">
              <v-app-bar absolute color="#6A76AB" dark shrink-on-scroll prominent
                src="https://picsum.photos/1920/1080?random" fade-img-on-scroll scroll-target="#scrolling-techniques-4">
                <template v-slot:img="{ props }">
                  <v-img v-bind="props" gradient="to top right, rgba(100,115,201,.7), rgba(25,32,72,.7)"></v-img>
                </template>
        ...
        <v-row class="my-4" justify="center">
          <v-col cols="12">
            <h3>Toggle navigation drawers</h3>
          </v-col>
          <v-col cols="12">
